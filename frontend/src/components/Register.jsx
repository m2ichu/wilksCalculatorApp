...
const RegisterForm = () => {
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-300 to-indigo-200 p-4">
			<form
				className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-lg transform transition-all hover:scale-105"
				...
				<button
					type="submit"
					className="w-full mt-8 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition duration-300">
					Zarejestruj się
				</button>
			</form>
			<ToastContainer />
